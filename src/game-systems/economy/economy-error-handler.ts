...
export class EconomyErrorHandler {
    ...
    private correctEconomyData(village: Village, villageId: string): boolean {
        ...
        if (village.economy.production) {
            Object.keys(village.economy.production).forEach(resource => {
                ...
                village.economy.production[key] = this.clampToRange(original as number, this.ranges.production);
        ...
        if (village.economy.consumption) {
            Object.keys(village.economy.consumption).forEach(resource => {
                ...
                village.economy.consumption[key] = this.clampToRange(original as number, this.ranges.consumption);
        ...
        if (village.economy.buildings) {
            ...
            village.economy.buildings.count = this.clampToRange(originalCount as number, this.ranges.buildings);
            ...
            village.economy.buildings.constructionQueue = Math.max(0, Math.min(10, originalQueue as number));
    ...
    private correctStorageData(village: Village, villageId: string): boolean {
        ...
        Object.keys(village.storage).forEach(resource => {
            ...
            village.storage[key] = this.clampToRange(original as number, this.ranges.resources);
