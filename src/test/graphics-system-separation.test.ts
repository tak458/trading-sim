...
import type {
  ...
  RenderConfig,
  UIRenderer,
} from "../graphics/interfaces/renderer";
...
describe("Graphics System Separation", () => {
  ...
  describe("Renderer Interface Separation", () => {
    it("should render map data without depending on game logic implementation", () => {
      ...
      expect(mockMapRenderer.renderMap).toHaveBeenCalledWith(
        mockMapData,
        renderConfig,
      );
    ...
    it("should render villages without depending on village logic", () => {
        ...
        },
        {
          ...
          economy: {
            ...
            supplyDemandStatus: {
              ...
              wood: "balanced" as const,
              ore: "critical" as const,
            },
          },
        },
      ];
      ...
      expect(mockMapRenderer.renderVillages).toHaveBeenCalledWith(
        mockVillages,
        renderConfig,
      );
    ...
    it("should render roads without depending on trade logic", () => {
      ...
      expect(mockMapRenderer.renderRoads).toHaveBeenCalledWith(
        mockRoads,
        renderConfig,
      );
  ...
  describe("UI System Separation", () => {
    it("should handle tooltips independently of game data", () => {
      ...
      expect(mockUIRenderer.showTooltip).toHaveBeenCalledWith(
        100,
        200,
        tooltipContent,
      );
    ...
    it("should update village texts with pure data", () => {
      ...
      expect(mockUIRenderer.updateVillageTexts).toHaveBeenCalledWith(
        mockVillages,
        renderConfig,
      );
  ...
  describe("Input System Separation", () => {
    it("should handle input events independently of game logic", () => {
      ...
      expect(mockInputHandler.onTileClick).toHaveBeenCalledWith(
        mockTileClickCallback,
      );

      mockInputHandler.onTileHover(mockTileHoverCallback);
      expect(mockInputHandler.onTileHover).toHaveBeenCalledWith(
        mockTileHoverCallback,
      );

      mockInputHandler.onKeyPress("R", mockKeyCallback);
      expect(mockInputHandler.onKeyPress).toHaveBeenCalledWith(
        "R",
        mockKeyCallback,
      );
    });
