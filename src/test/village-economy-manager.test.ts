...
describe("VillageEconomyManager", () => {
  ...
  describe("updateVillageEconomy", () => {
    ...
    it("should handle errors gracefully", () => {
      ...
      expect(["balanced", "shortage", "critical", "surplus"]).toContain(
        testVillage.economy.supplyDemandStatus.food,
      );
    });
  });
  ...
  describe("calculateProduction", () => {
    it("should calculate production based on available resources and village stats", () => {
      ...
      const production = manager.calculateProduction(
        testVillage,
        availableResources,
      );
    ...
    it("should scale production with population and buildings", () => {
      ...
      const baseProduction = manager.calculateProduction(
        testVillage,
        availableResources,
      );
      const scaledProduction = manager.calculateProduction(
        largerVillage,
        availableResources,
      );
  ...
  describe("calculateConsumption", () => {
    it("should calculate food consumption based on population", () => {
      ...
      const expectedFoodConsumption =
        testVillage.population *
        DEFAULT_SUPPLY_DEMAND_CONFIG.foodConsumptionPerPerson;
    ...
    it("should calculate building construction consumption", () => {
      ...
      const expectedWoodConsumption =
        2 * DEFAULT_SUPPLY_DEMAND_CONFIG.buildingWoodCost;
      const expectedOreConsumption =
        2 * DEFAULT_SUPPLY_DEMAND_CONFIG.buildingOreCost;
